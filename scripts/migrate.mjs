...
const {
  ...
  NEXT_PUBLIC_SANITY_AUTH_TOKEN,
	NEXT_PUBLIC_SANITY_API_VERSION, // Sanity API token
...
const targetClient = createClient({
  ...
  dataset: NEXT_PUBLIC_SANITY_DATASET, // Default to "production" if not set
  useCdn: false, // Disable CDN for real-time updates
  apiVersion: NEXT_PUBLIC_SANITY_API_VERSION, // Sanity API version
