...
const AboutHero = () => {
  return (
    <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center bg-white mt-16 md:mt-32 px-4">
      <div className="w-[200px] md:w-[650px] h-[200px] md:h-[478px] bg-[#007580] p-6 flex flex-col justify-start items-start text-left text-white">
        ...
        <div className="pl-4 lg:mb-10 md:pl-6">
          <button className="bg-[#029FAE] lg:mb-10 text-white px-6 md:px-8 py-3 md:py-4 text-[14px] md:text-[16px] font-normal">
            View collection
          </button>
        </div>
      </div>
