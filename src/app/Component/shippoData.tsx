...
//       {/* Shipment Details */}
//       {checkoutStatus && (
//         <p className="text-blue-600 mt-4 text-center text-3xl font-semibold">
//           {checkoutStatus}
//         </p>
//       )}
//       {shipmentDetails && (
...
//             </p>
//             <p>
//               <strong>Carrier:</strong> {trackingData.trackingDetails.carrier}
//             </p>
//             <p>
//               <strong>Status:</strong> {trackingData.trackingDetails.status}
//             </p>
//             <p>
//               <strong>Status Details:</strong>{" "}
//               {trackingData.trackingDetails.status_details || "N/A"}
//             </p>
//             <p>
//               <strong>ETA:</strong> {trackingData.trackingDetails.eta || "N/A"}
//             </p>
//             <p>
...
//                       <p>
//                         <strong>Date:</strong>{" "}
//                         {new Date(historyItem.status_date).toLocaleString()}
//                       </p>
//                       <p>
      ...
      <div className="mt-6 bg-white p-6 rounded-lg shadow-lg shadow-gray-600">
        ...
        {trackingData && trackingData.trackingDetails && (
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-bold mt-4">Tracking History</h3>
            {trackingData.trackingDetails.tracking_history?.filter(
              (historyItem) => historyItem.status === "TRANSIT"
            ).length > 0 ? (
              <ul className="list-disc ml-6">
                {trackingData.trackingDetails.tracking_history
